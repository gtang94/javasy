...
public class Xml2Word2Pdf {
    ...
    public static void main(String[] args) throws Exception {
        ...
        word2Pdf("/Users/tangguoqiang/data/work/javasy/finejardata/templates/test.doc", null);
        System.exit(0);


        long start = System.currentTimeMillis();
        //1.基础数据定义
        String templatePath = "/Users/tangguoqiang/data/work/javasy/finejardata/templates/";//模板路径/生成文档存放路径
        String sourceFile = templatePath+"order.doc";//生成的word文档路径和名称
        String templateName = "word_2003.ftl";//模板名称
        String sealImgPath = "/Users/tangguoqiang/data/work/javasy/finejardata/templates/liangzai.png";//盖章图片路径
        String nameImgPath = "/Users/tangguoqiang/data/work/javasy/finejardata/templates/zhangjie.jpg";//名字图片路径
        //2. dataMap的赋值
